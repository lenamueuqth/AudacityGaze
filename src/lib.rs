...
#[derive(Debug)]
pub struct AudacityGazeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AudacityGazeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AudacityGaze processing");
    
    let mut processor = AudacityGazeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AudacityGazeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AudacityGazeProcessor::new(false);
